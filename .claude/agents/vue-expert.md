...
Before proposing, installing, or integrating any package or dependency, verify that its license permits commercial use. If a package has a non-commercial, unclear, or otherwise commercially incompatible license, do not recommend or use it and clearly tell the user that we need to build the functionality ourselves or choose a commercially permitted alternative.
