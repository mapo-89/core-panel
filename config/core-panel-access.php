...
return [
    ...
    'resources' => [
        ...
        'database-backups' => ['create', 'view', 'update', 'restore', 'delete'],
        'system-updates' => ['view', 'update'],
    ],
    ...
    'permission_groups' => [
        ...
        'system' => ['settings', 'files', 'activity-logs', 'authentication-logs', 'database-backups', 'system-updates'],
    ...
    'role_permissions' => [
        ...
        'admin' => [
            ...
            'database-backups.create', 'database-backups.view', 'database-backups.update', 'database-backups.restore', 'database-backups.delete',
            'system-updates.view', 'system-updates.update',
        ],
        'user' => [
            'dashboard.view',
        ],
    ...
    'route_permissions' => [
        ...
        'core-panel.administration.index' => null,
        'core-panel.authentication-logs.index' => null,
        'core-panel.authentication-logs.show' => 'authentication-logs.view',
        'core-panel.database-backups.destroy' => 'database-backups.delete',
        'core-panel.database-backups.download' => 'database-backups.view',
        'core-panel.database-backups.download-sql' => 'database-backups.view',
        'core-panel.database-backups.emergency-kit' => 'database-backups.update',
        'core-panel.database-backups.import' => 'database-backups.create',
        'core-panel.database-backups.restore' => 'database-backups.restore',
        'core-panel.database-backups.restore.status' => 'database-backups.restore',
        'core-panel.database-backups.settings.update' => 'database-backups.update',
        ...
        'core-panel.settings.logo.destroy' => 'settings.update',
        'core-panel.settings.logo.store' => 'settings.update',
