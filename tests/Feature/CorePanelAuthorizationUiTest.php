...
it('ships the permission middleware, menu filtering, and frontend authorization helpers', function (): void {
    ...
    $appSidebar = file_get_contents(__DIR__.'/../../stubs/resources/js/layouts/components/AppSidebar.vue');
    ...
    $menuBuilder = file_get_contents(__DIR__.'/../../stubs/resources/js/composables/useMenuBuilder.ts');
    ...
    expect($provider)->toContain("aliasMiddleware('check.permission', CheckPermission::class)")
        ...
        ->and($appSidebar)->toContain("import { useAdminMenu } from '@/composables/useAdminMenu'")
        ...
        ->and($header)->toContain("import { useCan } from '@/composables/useCan'")
