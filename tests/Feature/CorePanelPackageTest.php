...
it('ships scaffold linting, formatting and ci workflow configuration', function (): void {
    ...
    expect($tsconfig['compilerOptions']['strict'])->toBeTrue()
        ...
        ->and($workflow)->toContain('name: Frontend Quality (${{ matrix.variant }})')
        ->and($workflow)->toContain('bash .github/scripts/frontend-quality.sh ${{ matrix.variant }}')
        ->and($workflow)->toContain('name: Install Smoke (${{ matrix.variant }})')
        ->and($workflow)->toContain('variant:')
        ->and($workflow)->toContain('- core')
        ->and($workflow)->toContain('- tenancy')
        ...
        ->and($workflow)->toContain('bash .github/scripts/install-smoke.sh ${{ matrix.variant }}')
