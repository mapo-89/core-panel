...
it('ships scaffold linting, formatting and ci workflow configuration', function (): void {
    ...
    expect($tsconfig['compilerOptions']['strict'])->toBeTrue()
        ...
        ->and($workflow)->toContain('name: Frontend Quality (${{ matrix.package }})')
        ->and($workflow)->toContain('bash .github/scripts/frontend-quality.sh ${{ matrix.package }}')
        ->and($workflow)->toContain('name: Install Smoke (${{ matrix.package }})')
        ->and($workflow)->toContain('package:')
        ->and($workflow)->toContain('- core-package')
        ->and($workflow)->toContain('- tenancy-addon')
        ...
        ->and($workflow)->toContain('bash .github/scripts/install-smoke.sh ${{ matrix.package }}')
