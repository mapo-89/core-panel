...
it('generates the expected crud scaffold', function (): void {
    ...
    expect($migrationFiles)->not->toBeFalse()
        ...
        ->and(file_get_contents($basePath.'/resources/js/pages/Products/Index.vue'))->toContain('@/actions/App/Domains/Product/Http/Controllers/ProductController')
        ->and(file_get_contents($basePath.'/resources/js/pages/Products/Create.vue'))->toContain('@/actions/App/Domains/Product/Http/Controllers/ProductController')
        ->and(file_get_contents($basePath.'/resources/js/pages/Products/Edit.vue'))->toContain('@/actions/App/Domains/Product/Http/Controllers/ProductController')
        ->and(file_get_contents($basePath.'/resources/js/pages/Products/Show.vue'))->toContain('@/actions/App/Domains/Product/Http/Controllers/ProductController')
