...
final class MakeFormCommand extends Command
{
    use InteractsWithGeneratorPrompts;

    protected $signature = 'core-panel:make-form
        {name : Form class name}
        {--force : Overwrite existing files}
        {--base-path= : Override the target base path}';

    protected $description = 'Generate a FormBuilder form class.';

    protected $aliases = ['core:make-form'];
    ...
    public function handle(): int
    {
        ...
        $this->components->info('Form generated.');
