        ...
        return [
            ...
            'auth' => [
                ...
                'fields' => [
                    ...
                    'oidc_client_id' => [
                        'default' => (string) config('services.oidc.client_id', ''),
                        'help' => __('core-panel::settings.help.oidc_client_id'),
                        'is_localized' => false,
                        'is_public' => false,
                        'label' => __('core-panel::settings.fields.oidc_client_id'),
                        'rules' => ['nullable', 'string', 'max:255'],
                        'type' => 'text',
                    ],
                    'oidc_client_secret' => [
                        'default' => (string) config('services.oidc.client_secret', ''),
                        'help' => __('core-panel::settings.help.oidc_client_secret'),
                        'is_localized' => false,
                        'is_public' => false,
                        'label' => __('core-panel::settings.fields.oidc_client_secret'),
                        'rules' => ['nullable', 'string', 'max:255'],
                        'type' => 'text',
                    ],
                    'oidc_issuer' => [
                        'default' => (string) config('services.oidc.issuer', ''),
                        'help' => __('core-panel::settings.help.oidc_issuer'),
                        'is_localized' => false,
                        'is_public' => false,
                        'label' => __('core-panel::settings.fields.oidc_issuer'),
                        'rules' => ['nullable', 'url', 'max:2048'],
                        'type' => 'text',
                    ],
                    'oidc_label' => [
                        'default' => (string) config('core-panel.auth.socialite.providers.oidc.label', 'OpenID Connect'),
                        'help' => __('core-panel::settings.help.oidc_label'),
                        'is_localized' => false,
                        'is_public' => true,
                        'label' => __('core-panel::settings.fields.oidc_label'),
                        'rules' => ['nullable', 'string', 'max:80'],
                        'type' => 'text',
                    ],
                    ...collect(['avatar', 'email', 'id', 'name', 'nickname'])
                        ->mapWithKeys(fn (string $claim): array => ["oidc_claim_{$claim}" => [
                            'default' => (string) config("services.oidc.claims.{$claim}", $claim === 'id' ? 'sub' : $claim),
                            'help' => __('core-panel::settings.help.oidc_claim'),
                            'is_localized' => false,
                            'is_public' => false,
                            'label' => __('core-panel::settings.fields.oidc_claim', ['claim' => $claim]),
                            'rules' => ['nullable', 'string', 'max:255'],
                            'type' => 'text',
                        ]])
                        ->all(),
                    ...
                    'social_master_provider' => [
                        ...
                        'options' => [
                            ...
                            [
                                'label' => __('page-auth.socialite.providers.oidc'),
                                'value' => 'oidc',
                            ],
                        ],
                        'rules' => ['nullable', 'string', 'in:,github,google,microsoft,oidc'],
                        'type' => 'select',
                    ],
                    ...
                    'social_oidc_enabled' => [
                        'default' => (bool) config('core-panel.auth.socialite.providers.oidc.enabled', false),
                        'help' => __('core-panel::settings.help.social_oidc_enabled'),
                        'is_localized' => false,
                        'is_public' => true,
                        'label' => __('core-panel::settings.fields.social_oidc_enabled'),
                        'rules' => ['required', 'boolean'],
                        'type' => 'boolean',
                    ],
                    'two_factor_enabled' => [
