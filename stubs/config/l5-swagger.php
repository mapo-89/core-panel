...
return [
    ...
    'documentations' => [
        'default' => [
            'api' => [
                'title' => sprintf('%s API', (string) config('app.name', 'CorePanel')),
            ],
            'routes' => [
    ...
    'defaults' => [
        'routes' => [
            ...
            'middleware' => [
                'api' => ['web', 'auth', 'core-panel.verified', 'core-panel.api-docs'],
                'asset' => ['web', 'auth', 'core-panel.verified', 'core-panel.api-docs'],
                'docs' => ['web', 'auth', 'core-panel.verified', 'core-panel.api-docs'],
                'oauth2_callback' => ['web', 'auth', 'core-panel.verified', 'core-panel.api-docs'],
            ],
            'group_options' => [],
        ],
        'paths' => [
        ...
        'ui' => [
            'display' => [
                ...
                'request_duration' => env('L5_SWAGGER_UI_REQUEST_DURATION', true),
            ],
            'authorization' => [
