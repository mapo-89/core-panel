...
import DatabaseBackupRestoreDialog from '@/pages/Admin/Administration/components/DatabaseBackupRestoreDialog.vue'
import DatabaseBackupSettingsDialog from '@/pages/Admin/Administration/components/DatabaseBackupSettingsDialog.vue'
...
const tableOptions = computed(() => props.tableOptions ?? [])
...
function createBackup(): void {
    ...
    router.post(props.routes.store, undefined, {
        onFinish: () => {
